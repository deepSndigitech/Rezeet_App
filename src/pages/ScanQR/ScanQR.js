...
import { ImageApi, apiMethod, apiRoutes, apimethods } from '../../apiConfig/apiurl';
...
const ScanQR = props => {
  ...
  const onSuccess = async (e) => {
    ...
    setScanResult(JSON.parse(e?.data))
                ...
                <>
                  ...
                  <View style={{ marginTop: height / 2, }}>
                    <ImageBackground source={require('../../Images/rezeetImg/scanImageBack.gif')} style={{ height: 250, width: 260, justifyContent: 'center', }}>
                      ...
                      <TouchableOpacity style={{ marginHorizontal: 15, alignSelf: 'flex-end' }} onPress={() => setFlash(!flash)}>
                        <Image
                          source={flash ?
